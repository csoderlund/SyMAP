 ...
 * CAS556 was in TableDataPanel file.
 */
public class TableExport extends JDialog {
			...
			try {
				...
				for(int x=0; x<selNum; x++) {
					...
					for (int i=0; i<2; i++) {
						...
						String seq = tdp.theParentFrame.getSequence(rd.start[i], rd.end[i], rd.chrIdx[i]);
    ...
    ////////////////////////////////////////////////////////////////////////
    // CAS548 add append; CAS555 these two methods repeated in TableReport
